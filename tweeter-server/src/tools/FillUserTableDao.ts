...
export class FillUserTableDao {
  private readonly tableName = UsersTable.TABLE;
  private readonly userAliasAttribute = UsersTable.ATTR_ALIAS;
  private readonly userFirstNameAttribute = UsersTable.ATTR_FIRST_NAME;
  private readonly userLastNameAttribute = UsersTable.ATTR_LAST_NAME;
  private readonly userImageUrlAttribute = UsersTable.ATTR_IMAGE_URL;
  private readonly passwordHashAttribute = UsersTable.ATTR_PASSWORD_HASH;
  private readonly followeeCountAttribute = UsersTable.ATTR_FOLLOWEE_COUNT;
  private readonly followerCountAttribute = UsersTable.ATTR_FOLLOWER_COUNT;
