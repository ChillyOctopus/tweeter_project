...
interface Props {
    uuid: string; // Unique identifier for this instance of the component.
    itemDescription: string; // Description of the type of items being displayed (e.g., "feed", "story")
    featureUrl: string; // URL path for the feature (e.g., "/feed", "/story")
    loadMoreFunction: (
        authToken: AuthToken,
        userAlias: string,
        pageSize: number,
        lastItem: Status | null
    ) => Promise<[Status[], boolean]>; // Function to load more items 
}
