...
interface Props {
    uuid: string;
    itemDescription: string; // e.g. "followers" or "followees"
    featureUrl: string; // e.g. "/followers" or "/followees"
    loadMoreFunction: (authToken: AuthToken, userAlias: string, pageSize: number, lastItem: User | null) => Promise<[User[], boolean]>;
}
